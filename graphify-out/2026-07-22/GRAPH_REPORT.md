...
## Corpus Check
- 80 files · ~151,323 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 599 nodes · 863 edges · 58 communities (48 shown, 10 thin omitted)
...
5. `build_report_autonomously()` - 17 edges
6. `planner_node()` - 16 edges
...
Cohesion: 0.10
Nodes (48): cached_search(), citation_mapper_node(), _classify_topic_type(), _cross_check_numeric_claims(), _cross_section_duplication_check(), emit_source(), emit_thought(), evaluator_node() (+40 more)

### Community 2 - "main.py"
Cohesion: 0.06
Nodes (65): _auto_research_profile(), build_report_autonomously(), _call_external_llm(), call_llm(), _classify_source_tier(), _classify_topic_type(), _coerce_sub_questions(), compute_overall() (+57 more)
